...
public class PostsApiControllerTest {
    ...
    public void Posts_등록된다() throws Exception {
        ...
        //when
        ResponseEntity<Long> resposeEntity = restTemplate.postForEntity(url, requestDto, Long.class);

        //then
        assertThat(resposeEntity.getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(resposeEntity.getBody()).isGreaterThan(0L);
